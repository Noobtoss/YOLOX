...
class SupervisedContrastiveLoss(nn.Module):
    ...
    def fix_01(self, projections, onehot_targets):
    ...
    def fix_02(self, log_prob, mask_combined, cardinality_per_samples):
    ...
    def forward(self, projections, targets):
        ...
        """
        projections, targets = self.fix_01(projections, targets)
        ...
        supervised_contrastive_loss_per_sample = self.fix_02(log_prob, mask_combined, cardinality_per_samples)
